...
public class State
{
    ...
    public State (Action active, Action onEnter, Action onExit) //Create constructor which uses methods (actions) as parameters.  We then assign these methods to variables of the same type. 
    {
        ActiveAction = active;
    ...
    public void Action() //Create three methods to be called when we use/ transition a state. Execute, OnEnter and OnExit states. 
    {
